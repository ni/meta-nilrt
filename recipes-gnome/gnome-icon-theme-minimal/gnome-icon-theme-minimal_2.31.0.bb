DESCRIPTION = "Reduced size GNOME 2 default icon themes"
...
EXTRA_OECONF = "--with-iconmap=${@d.getVar('STAGING_LIBEXECDIR_NATIVE', True).replace('gnome-icon-theme-minimal', 'icon-naming-utils')}/icon-name-mapping"

...
KERNEL_MODULE_PACKAGE_PREPEND = "kernel-module-debug-%s"
...
# Remove unecessary packages (kernel, kernel-vmlinux, kernel-dev) for optional kernel
PACKAGES = "kernel-base kernel-image ${KERNEL_MODULES_META_PACKAGE}"

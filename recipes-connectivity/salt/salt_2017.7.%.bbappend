...
SRC_URI = "${NILRT_GIT}/salt.git;protocol=git;branch=nilrt/comms-3.0/2017.7 \
...
SRCREV = "75962d1d181d466eaf5bb61ce6514e47b9955970"
PV = "2017.7+git${SRCPV}"
...
RDEPENDS_${PN}-minion = "python ${PN}-common (= ${EXTENDPKGV}) python-msgpack python-avahi python-pyinotify python-pyroute2 python-pycrypto python-pika python-pyconnman python-argparse python-psutil"
RDEPENDS_${PN}-common = " \
    lsb \
    python \
	python-configparser \
...
RDEPENDS_${PN}-tests += "python-pyzmq python-six python-psutil"
RDEPENDS_${PN}-tests_remove = "python-image"

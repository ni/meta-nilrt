...
do_install_append_xilinx-zynqhf() {
    ...
    install -m 0644 ${PKG_CONFIG_SYSROOT_DIR}/boot/linux_migrate.itb ${D}/.newNILinuxRT/
    install -m 0644 ${PKG_CONFIG_SYSROOT_DIR}/boot/linux_safemode.itb ${D}/.newNILinuxRT/.safe/
